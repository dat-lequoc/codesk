    ...
    <div className="relative" ref={menu}>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 bottom-[calc(100%+8px)] z-30 flex w-[290px] max-w-[calc(100vw-32px)] flex-col overflow-hidden rounded-xl border border-line-strong bg-ink-700 shadow-2xl shadow-black/55"
        >
