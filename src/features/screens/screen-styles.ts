...
const READING_WIDTH = 'w-[min(780px,calc(100%-96px))]'
...
export const threadHeader = 'flex h-[45px] items-center gap-2.5 border-b border-ink-700 px-4'
export const threadHeaderTitle = 'max-w-[420px] truncate text-[15px]'
export const threadScroll = 'scroll-thin flex-1 overflow-auto pt-8 pb-[164px]'
export const threadScrollFilePreview = 'mr-[var(--file-preview-width)]'
export const historyScroll = 'pb-25'
export const historyScrollContinuable = 'pb-27'

export const threadComposer = `absolute bottom-3.5 left-1/2 -translate-x-1/2 ${READING_WIDTH} overflow-hidden rounded-2xl border border-line-strong bg-surface`
export const threadComposerFilePreview =
  'left-9 right-[calc(var(--file-preview-width)+36px)] w-auto translate-x-0'
...
export const composerBar = 'flex h-[47px] items-center gap-2.5 px-3'
...
export const sendButton =
  'grid size-[30px] shrink-0 place-items-center rounded-full bg-ink-100 text-ink-850 hover:bg-fg disabled:opacity-35'
...
export const historyNotice = `absolute bottom-3.5 left-1/2 -translate-x-1/2 ${READING_WIDTH} flex min-h-[58px] items-center gap-[11px] rounded-xl border border-line-strong bg-ink-850 px-3 py-2.5 text-muted`
