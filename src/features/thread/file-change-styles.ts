/** Shared between the live FileChangeCard and the historical variant in ThreadEvent. */
export const fileChangeCard = 'my-1 overflow-hidden rounded-md border border-line bg-ink-850'
export const fileChangeHeader = 'flex min-h-[54px] items-center gap-2.5 bg-ink-850 px-2.5 py-2'
export const fileChangeIcon =
  'grid size-[31px] shrink-0 place-items-center rounded-md bg-ink-900 text-fg-soft shadow-[inset_0_0_0_1px_var(--color-ink-700)]'
export const fileChangeList = 'border-t border-ink-650'
...
export const fileChangeCounts =
  'flex shrink-0 min-w-0 sm:min-w-[56px] justify-end gap-1 font-mono text-[10.5px]'
