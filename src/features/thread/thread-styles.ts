...
export const requestCard =
  'my-4 mb-6 rounded-xl border border-amber-signal-950 bg-amber-signal-950/60 px-3.5 py-3'
export const requestCardResolved = 'border-line-strong opacity-65'
export const requestTitle = 'text-xs text-amber-signal-400'
export const requestBody = 'my-2 mb-3 font-mono text-[11px]/[1.5] whitespace-pre-wrap text-fg-soft'
export const requestActions = 'flex gap-[7px]'
export const requestButton =
  'h-[29px] rounded-[7px] border border-line-strong bg-ink-600 px-2.5 text-[10px] hover:bg-ink-500'
export const requestDecline = 'text-ember-400'

export const usageCard =
  'my-3 mb-6 overflow-hidden rounded-xl border border-grass-600/45 bg-grass-950'
export const usageHeader =
  'flex h-[38px] items-center gap-2 border-b border-grass-600/40 px-3 text-grass-400'
export const usageGrid = 'grid grid-cols-2 gap-px bg-grass-600/40'
export const usageCell = 'min-h-[66px] bg-grass-950 p-2.5'
export const usageLabel = 'block text-[9px] tracking-wider text-grass-400/80 uppercase'
export const usageValue = 'mt-[5px] block text-[13px] font-semibold text-fg'
export const usageNote = 'mt-[3px] block font-mono text-[9px] text-grass-400/70 not-italic'

export const turnBoundary =
  'my-7 mb-[30px] grid grid-cols-[1fr_auto_1fr] items-center gap-3 text-[10px] text-dim'
