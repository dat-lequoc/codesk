...
export const providerIcon = (provider: Provider['id'], size = 16) => (
...
export function ProviderIcon({ provider, size = 16, className = '' }: ProviderIconProps) {
  ...
  const classes = `block shrink-0 text-muted${className ? ` ${className}` : ''}`
  const common = {
    className: classes,
    width: size,
    height: size,
    ...
    return (
      <svg {...common} viewBox="0 0 24 24">
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M3 4h8v16H3V4Zm3 3v10h2V7H6Zm7-3h8v7h-3V7h-2v10h2v-4h3v7h-8V4Z"
        />
      </svg>
    )
    ...
    return (
      <svg {...common} viewBox="0 0 24 24">
        ...
        <path
          ...
          strokeWidth="2"
          d="m4.2 5.5 3.15 1.5L4.2 8.5M9.4 9.25h3.15"
        />
        <path
          fill="#fff"
          d="M10.55 23.35v-5.9c0-4.58 2.4-7.4 6.4-7.4 4.12 0 6.4 2.62 6.4 7.15v6.15h-3.88c-.5 0-.95-.15-1.34-.44-.75.57-1.65.85-2.69.85-1.08 0-1.98-.32-2.69-.94-.43.35-.96.53-1.58.53Z"
        />
        <ellipse
          cx="16.1"
          cy="16.05"
        ...
        <ellipse
          ...
          ry="1.2"
          fill="#111"
          transform="rotate(8 19.45 16.05)"
        />
      </svg>
    )
  ...
  if (provider === 'pi')
    return (
      <svg {...common} viewBox="0 0 800 800">
        <path
          fill="currentColor"
          fillRule="evenodd"
    ...
    return (
      <svg {...common} viewBox="0 0 24 24">
        <defs>
          ...
          >
            <stop stopColor="#F6D84A" />
            <stop offset=".24" stopColor="#FF5A51" />
            <stop offset=".52" stopColor="#55B873" />
            <stop offset=".75" stopColor="#3987F6" />
            <stop offset="1" stopColor="#55A7FF" />
          </linearGradient>
        </defs>
        <path
          d="M3.2 19.6C7.7 18.1 8.1 4.4 12 4.4s4.3 13.7 8.8 15.2"
          fill="none"
